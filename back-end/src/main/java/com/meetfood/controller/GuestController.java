...
public class GuestController {
    ...
    public @ResponseBody   List<Guest>  returnMessage(@RequestParam Integer id){
        return guestRepository.findMessageById(id);
        //return JSONArray.fromObject(n);
    }
    ...
    public @ResponseBody Iterable<Guest> getAllUsers() {
        ...
        //Iterable<Guest> n = guestRepository.findAll();
        //System.out.println(n);
        //JSONArray json = JSONArray.fromObject(n);

        //JsonConfig jsonConfig = new JsonConfig();
        //jsonConfig.setCycleDetectionStrategy(CycleDetectionStrategy.LENIENT);
        //return JSONArray.fromObject(n,jsonConfig);
